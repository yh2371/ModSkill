...
import numpy as np
import copy
from phc.learning.modskill_network import ModSkillNetwork
from rl_games.algos_torch import torch_ext

DISC_LOGIT_INIT_SCALE = 1.0


class AMPModSkillNetworkBuilder(AMPBuilder):
    ...
    def build(self, name, **kwargs):
        net = AMPModSkillNetworkBuilder.Network(self.params, **kwargs)
        return net
    ...
    class Network(AMPBuilder.Network):
        ...
        def __init__(self, params, **kwargs):
            ...
            self.modskill_network = ModSkillNetwork(actor_mlp_args, output_size=kwargs['actions_num'])
        ...
        def eval_actor(self, obs_dict):
            ...
            a_out, a_outs = self.modskill_network(a_out)
